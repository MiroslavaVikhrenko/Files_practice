...
Каждая заметка имеет заголовок и текст, а также дату создания. Затем можно создать класс «NoteManager», 
    который управляет списком заметок и позволяет добавлять, удалять и редактировать заметки, 
    а также сохранять и загружать их из файла.
     */
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string filePath = "notes.json"; //"C:\Users\mvikh\source\repos\Files_practice\20250614_Task10\bin\Debug\net8.0\notes.json"
